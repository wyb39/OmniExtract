"""
Task card data generation for gui (Jinja-based, no Dash dependency).

Returns plain dicts that templates can render.
...
# Map each module key -> (runs subdirectory under gui/runs, human title)
MODULE_RUN_DIRS = {
